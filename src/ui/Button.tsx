...
const variantStyles: Record<Variant, CSSProperties> = {
  ...
  danger:  { background: COLOR.dangerBg, color: COLOR.danger, border: `1px solid ${COLOR.dangerLine}` },
...
export function Button({
  children, onClick, disabled, loading, variant = 'primary', size = 'md', full, style, type = 'button',
}: ButtonProps) {
