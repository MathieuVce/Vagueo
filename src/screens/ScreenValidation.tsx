...
const s = {
  ...
  clockSec: {
    opacity: 0.35, fontSize: 46, marginLeft: 3,
  } satisfies CSSProperties,
  hint: {
    marginTop: 20, fontSize: 12, lineHeight: 1.5,
    textAlign: 'center', maxWidth: 280, color: 'rgba(0,0,0,0.55)',
  } satisfies CSSProperties,
  footer: {
  ...
  return (
    <div style={s.root}>
      ...
      <div style={s.content}>
        ...
        <div style={s.hint}>
          La couleur de fond et l'heure changent en direct.<br />
