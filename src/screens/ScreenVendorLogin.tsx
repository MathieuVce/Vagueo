...
const GoogleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <path
      fill="#4285F4"
      d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844c-.209 1.125-.843 2.078-1.796 2.717v2.258h2.908C16.658 14.013 17.64 11.71 17.64 9.2z"
    />
    <path
      fill="#34A853"
...
export default function ScreenVendorLogin({
  standName,
  onSignIn,
  error,
  loading,
}: ScreenVendorLoginProps) {
  const p = PALETTE;
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          height: 6,
          background: `linear-gradient(90deg, oklch(0.46 0.13 250), oklch(0.74 0.18 55))`,
        }}
      />
