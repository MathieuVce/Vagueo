    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ marginTop: 20, textAlign: 'center' }}>
          ...
          <div style={{
            marginTop: 6, fontFamily: FONT_MONO,
        ...
        {!isOpen && (
          <div style={{
            ...
            background: 'oklch(0.97 0.02 55)', border: '1px solid oklch(0.90 0.06 55)',
            fontSize: 12, color: 'oklch(0.45 0.12 55)', textAlign: 'center', maxWidth: 260,
          }}>
            La file est fermée — ouvrez-la depuis le dashboard pour que les clients puissent scanner.
          </div>
        )}
      </div>

      {/* Actions */}
      <div style={{ padding: '0 22px 44px', display: 'flex', flexDirection: 'column', gap: 10, flexShrink: 0 }}>
        <button
          onClick={handleShare}
          disabled={sharing}
          style={{
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button
            ...
            style={{
              ...
              borderRadius: 14, fontFamily: FONT, fontSize: 14, fontWeight: 500,
