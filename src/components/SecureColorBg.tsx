...
export default function SecureColorBg({ bg = '#39FF14' }: SecureColorBgProps) {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, background: bg, overflow: 'hidden' }}>
      ...
      >
        <path
          d="M0 200 Q 100 140 200 200 T 400 200 T 600 200 T 800 200"
          stroke="rgba(0,0,0,0.18)"
          strokeWidth="60"
          fill="none"
        />
        <path
          d="M0 560 Q 100 500 200 560 T 400 560 T 600 560 T 800 560"
      ...
      >
        <path
          d="M0 380 Q 100 320 200 380 T 400 380 T 600 380 T 800 380"
          stroke="rgba(0,0,0,0.10)"
          strokeWidth="80"
          fill="none"
        />
        <path
          d="M0 720 Q 100 660 200 720 T 400 720 T 600 720 T 800 720"
